...
- `pzoey-common` 为系统的公共模块，各种工具类，公共配置存在该模块

- `eladmin-system` 为系统核心模块也是项目入口模块，也是最终需要打包部署的模块

- `pzoey-logging` 为系统的日志模块，其他模块如果需要记录日志需要引入该模块

- `pzoey-tools` 为第三方工具模块，包含：图床、邮件、云存储、本地存储、支付宝

- `pzoey-codes` 为系统的代码生成模块，代码生成的模板在 system 模块中
...
- pzoey-logging 系统日志模块
- pzoey-tools 系统第三方工具模块
- pzoey-codes 系统代码生成模块
```
